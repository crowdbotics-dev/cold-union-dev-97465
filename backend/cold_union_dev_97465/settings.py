"""
Django settings for cold_union_dev_97465 project.
...
ROOT_URLCONF = 'cold_union_dev_97465.urls'
...
WSGI_APPLICATION = 'cold_union_dev_97465.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_union_dev_97465 API",
    "DESCRIPTION": "API documentation for cold_union_dev_97465 App",
    "VERSION": "v1",
}
